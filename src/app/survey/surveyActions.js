        ...
        const jsonCallbacks = {
            ...
            success: function(json) {
                ...
                data.surveyStack = questions.map((question, index) => {
                    ...
                    let { id, prompt, colName, answerRequired, ...rest } = question
                    questionPrototype.data.form = { id, prompt, colName, answerRequired }
                    Object.assign(questionPrototype.data.form, rest.fields)
